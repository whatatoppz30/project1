...
$selectinventions1="SELECT * FROM `tblotheriplog` WHERE otheripid ='$_GET[otheripid]'  AND otheriplogid ='$_GET[otheriplogid]' ";
                            ...
                            <form action="include/all_query.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                           ...
                                           <div class="form-group row">
                                            ...
                                            <input type="hidden" name="tmid" id="tmid" value="<?php echo $_GET['otheripid'] ?>">
                                             <input type="hidden" name="tmlogid" id="tmlogid" value="<?php echo $_GET['otheriplogid'] ?>">

                                     <div class="form-group row">
                                            <div class="col-12">
                                                <button type="submit" name="updateoptheriplog" class="btn btn-lg btn-alt-primary pull-right">UPDATE</button>
                                            </div>
                                        </div>
