...
$selectinventions1="SELECT * FROM `tblinventionlog` WHERE inventionid ='$_GET[inventionid]'  AND inventionlogid ='$_GET[tmlogid]' ";
                            ...
                            <form action="include/all_query.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-6">
                                               ...
                                               <input type="text" class="form-control form-control-lg" id="action" name="action"  required="" value="<?php echo $rowinventions1['action'] ?>">
                                            </div>

                                             <div class="col-6">
                                                <label class="col-form-label" for="val-username">Deadline</label>
                                               <input type="date" class="form-control form-control-lg" id="deadline" name="deadline"  value="<?php echo $rowinventions1['deadline'] ?>">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-6">
                                                ...
                                                <input type="date" class="form-control form-control-lg" id="notification" name="notification" value="<?php echo $rowinventions1['notification'] ?>">

                                            </div>

                                            <div class="col-6">
                                                <label class="col-form-label" for="val-username">Status</label>
                                                 <select  type="text" class="form-control form-control-lg" id="status" name="status"  required="" >


                                                    <option <?php echo $rowinventions1['status'] ?>> <?php echo $rowinventions1['status'] ?></option>
                                          ...
                                          <div class="form-group row">
                                               ...
                                               <label class="col-12 p-10 bg-primary-lighter text-primary-dark" for="">Attach File</label>
                                                 ...
                                                 <div class="col-7" id="atachmentdiv2">
                                                <!-- <input type="file" name="attachfile" class="form-control form-control-lg pull-right"> -->
                                                </div>
                                            ...
                                            <span class="btn btn-lg btn-alt-primary pull-right fa fa-plus-circle" style="margin-top: 5px;" onclick="addfile2()"> Add more File</span>
                                            ...
                                            <input type="hidden" name="tmid" id="tmid" value="<?php echo $_GET['inventionid'] ?>">
                                             <input type="hidden" name="tmlogid" id="tmlogid" value="<?php echo $_GET['tmlogid'] ?>">

                                     <div class="form-group row">
                                            <div class="col-12">
                                                <button type="submit" name="updateinventionlog1" class="btn btn-lg btn-alt-primary pull-right">UPDATE</button>
                                            </div>
                                        </div>
