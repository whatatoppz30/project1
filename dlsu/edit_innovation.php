...
$selectinventions1="SELECT * FROM `tblpartnerlog` WHERE partnerid ='$_GET[partnerid]'  ";
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-6">
                                                <label class="col-form-label" for="val-username">Status</label>
                                                 <input type="text" class="form-control form-control-lg" id="status" name="status"  required="" value="<?php echo $rowinventions1['status'] ?>">
                                            </div>
                                         ...
                                         <!--  <div class="form-group row">
                                            ...
                                            <input type="hidden" name="tmid" id="tmid" value="<?php echo $_GET['partnerid'] ?>">
                                             <input type="hidden" name="tmlogid" id="tmlogid" value="<?php echo $_GET['partnerlogid'] ?>">

                                     <div class="form-group row">
                                            <div class="col-12">
                                                <button type="submit" name="updatepartnerlog22" class="btn btn-lg btn-alt-primary pull-right">UPDATE</button>
                                            </div>
                                        </div>
