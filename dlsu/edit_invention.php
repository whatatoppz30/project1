...
$selectinventions1="SELECT * FROM `tblworklogs` WHERE workid ='$_GET[workid]'  AND worklogid ='$_GET[worklogid]' ";
                            ...
                            <form action="include/all_query.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                          ...
                                          <div class="form-group row">
                                            ...
                                            <input type="hidden" name="tmid" id="tmid" value="<?php echo $_GET['workid'] ?>">
                                             <input type="hidden" name="tmlogid" id="tmlogid" value="<?php echo $_GET['worklogid'] ?>">

                                     <div class="form-group row">
                                            <div class="col-12">
                                                <button type="submit" name="updateworklog" class="btn btn-lg btn-alt-primary pull-right">UPDATE</button>
                                            </div>
                                        </div>
