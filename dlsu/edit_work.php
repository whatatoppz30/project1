...
$selectinventions="SELECT * FROM `tblwork` WHERE workid ='$_GET[workid]'";
                            ...
                            <div class="block">
                                ...
                                <div class="block-content">
                                    <form action="include/all_query.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-8">
                                                <input type="text" class="form-control form-control-lg" id="trackingno" name="trackingno" value="<?php echo $rowinventions['trackingno']  ?>">
                                            </div>
...
<div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                           ...
                                           <div class="col-4" id="atachmentdiv2c"> 
                                            ...
                                            <div class="col-4">
                                                <button type="submit" name="updatesavework" class="btn btn-lg btn-alt-primary pull-right">UPDATE</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
