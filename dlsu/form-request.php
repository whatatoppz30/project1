                ...
                <div class="content">
                    ...
                    <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">Request Form</h3>
                        </div>
                        ...
                        <div class="block-content block-content-full">
                            ...
                            <div class="form-group row">
                                                <label class="col-12" for="example-textarea-input">Form Label</label>
                                                <div class="col-12">
                                                    <input type="text" class="form-control form-control-lg" id="example-text-input" placeholder="name">
                                                </div>
                            </div>


                             <div class="form-group row">                                            
                                            <label class="col-12">Upload Files</label>
                                            <div class="col-8">
                                                <div class="custom-file">
                                                    
                                                    <input type="file" class="custom-file-input form-control form-control-lg" id="" name="example-file-multiple-input-custom" data-toggle="custom-file-input" multiple="">
                                                    <label class="custom-file-label" for="example-file-multiple-input-custom">Choose file</label>
                                                </div>
                                            </div>
                             </div>

                                <div class=""><button type="button" class="btn btn-hero btn-info text-uppercase mb-10" onclick="window.location.href = '#';">
                                    <i class="fa fa-plus mr-5"></i>SUBMIT</button></div>
