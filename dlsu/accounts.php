                ...
                <div class="content">
                    ...
                    <div class="block">
                        ...
                        <div class="block-content block-content-full">
                            <div class=""><button type="button" class="btn btn-hero btn-info text-uppercase mb-10" onclick="window.location.href = 'account-add.php';">
                                    <i class="fa fa-plus mr-5"></i>Add Account</button></div>
                            <!-- DataTables functionality is initialized with .js-dataTable-full class in js/pages/be_tables_datatables.min.js which was auto compiled from _es6/pages/be_tables_datatables.js -->
                            
                            <table class="table table-bordered table-striped table-vcenter js-dataTable-full historyTable table-hover" id="accountTable">
