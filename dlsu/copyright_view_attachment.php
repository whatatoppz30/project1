...
$slect="SELECT * FROM `tblworklogs` WHERE workid='$_GET[copyrightid]' AND worklogid='$_GET[milestoneid]'";
...
{
 $slect1="SELECT * FROM `tblcopyrightattachment` WHERE copyrightid ='$_GET[copyrightid]' AND logid='CREATED'";
  ...
  while ($row1 = mysqli_fetch_assoc($runslect1))
 {
   echo ' <div class="col-md-6 col-xl-3" data-category="claims">
                                <a class="block block-rounded block-link-shadow"  href="assets/media/photos/'.$row1['attactment'].'" download>
                                    <div class="block-content block-content-full text-center">
                                        <div class="item item-circle bg-info-light text-info mx-auto my-20">
                                            <i class="fa fa-file-text-o"></i>
                                        </div>
                                        <div class="font-size-lg">'.$row1['attactment'].'</div>
...
{
     $slect1="SELECT * FROM `tblcopyrightattachment` WHERE logid='$_GET[milestoneid]'";
 $runslect1=mysqli_query($conn, $slect1);
  while ($row1 = mysqli_fetch_assoc($runslect1))
 {
   echo ' <div class="col-md-6 col-xl-3" data-category="claims">
