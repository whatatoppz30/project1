...
<html lang="en" class="no-focus">
 ...
 <form action="include/all_query.php" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group row">
                                                ...
                                                <div class="col-12">
                                                    <input class="form-control form-control-lg" id="activityname1" name="activityname1" rows="6" placeholder="Activity Name">
                                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                                ...
                                                <div class="col-12">
                                                    <textarea class="form-control form-control-lg" id="activityname" name="activityname" rows="6" placeholder="Content.."></textarea>
                                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                                ...
                                                <div class="col-12">
                                                    <input type="date" class="form-control form-control-lg" id="activitydate" name="activitydate" placeholder="Pick a date">
                                                </div>
                            </div>
                            ...
                            <div class="form-group row">                                            
                                ...
                                <div class=""><button type="submit" name="saveactivity" class="btn btn-hero btn-info text-uppercase mb-10" >
                                    <i class="fa fa-plus mr-5"></i>Add</button>
                                </div>
