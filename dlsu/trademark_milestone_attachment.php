...
$slect="SELECT * FROM `tbltrademarklog` WHERE trademarkid='$_GET[tmid]' AND trademarklog='$_GET[tmlogid]'";
...
{
   $slect1="SELECT * FROM `tblattachment` WHERE tmid='$_GET[tmid]'";
 $runslect1=mysqli_query($conn, $slect1);
  while ($row1 = mysqli_fetch_assoc($runslect1))
 {
   echo ' <div class="col-md-6 col-xl-3" data-category="claims">
                                <a class="block block-rounded block-link-shadow"  href="assets/media/photos/'.$row1['attachment'].'" download>
                                    <div class="block-content block-content-full text-center">
                                        <div class="item item-circle bg-info-light text-info mx-auto my-20">
                                            <i class="fa fa-file-text-o"></i>
                                        </div>
                                        <div class="font-size-lg">'.$row1['attachment'].'</div>
...
{
     $slect1="SELECT * FROM `tblattachment` WHERE tmid='$_GET[tmid]' AND logid ='$_GET[tmlogid]'";
 $runslect1=mysqli_query($conn, $slect1);
  while ($row1 = mysqli_fetch_assoc($runslect1))
 {
...
//                            $slect="SELECT * FROM `tbltrademarklog` WHERE trademarkid='$_GET[tmid]' AND trademarklog='$_GET[tmlogid]' AND relevantdoc !=''";
//  $runslect=mysqli_query($conn, $slect);
