...
$selectinventions1="SELECT * FROM `tbliprecordlog` WHERE iprecordid ='$_GET[iprecordid]'  AND iprecordlogid ='$_GET[tmlogid]'";
                            ...
                            <form action="include/all_query.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                          ...
                                          <div class="form-group row">
                                            ...
                                            <input type="hidden" name="tmid" id="tmid" value="<?php echo $_GET['iprecordid'] ?>">
                                             <input type="hidden" name="tmlogid" id="tmlogid" value="<?php echo $_GET['tmlogid'] ?>">

                                     <div class="form-group row">
                                            <div class="col-12">
                                                <button type="submit" name="updateiplog1" class="btn btn-lg btn-alt-primary pull-right">UPDATE</button>
                                            </div>
                                        </div>
