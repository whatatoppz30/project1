...
<html lang="en" class="no-focus">
                ...
                <div class="content">
                    ...
                    <div class="block">
                        ...
                        <?php 
                           ...
                           $slect="SELECT * FROM `tbliprecordlog` WHERE iprecordid='$_GET[iprecordid]' AND iprecordlogid='$_GET[iprecordlogid]'";
 ...
 while ($row = mysqli_fetch_assoc($runslect))
 {
    ...
    else
    {
               ...
               $slect1="SELECT * FROM `tblipdocs` WHERE iprecordid='$_GET[iprecordid]' AND logid='$_GET[iprecordlogid]' AND ipdoc !=''";
 $runslect1=mysqli_query($conn, $slect1);

 while ($row1 = mysqli_fetch_assoc($runslect1))
 {
echo ' <div class="col-md-6 col-xl-3" data-category="claims">
                                <a class="block block-rounded block-link-shadow"  href="assets/media/photos/'.$row1['ipdoc'].'" download>
                                    <div class="block-content block-content-full text-center">
                                        <div class="item item-circle bg-info-light text-info mx-auto my-20">
                                            <i class="fa fa-file-text-o"></i>
                                        </div>
                                        <div class="font-size-lg">'.$row1['ipdoc'].'</div>
                                        <div class="font-size-sm text-muted">-</div>
                                    </div>
                                </a>
                            </div>'; 
