...
$selectinventions1="SELECT * FROM `tbltrademarklog` WHERE trademarklog ='$_GET[tmlogid]'  ";
                            ...
                            <form action="include/all_query.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-6">
                                                <label class="col-form-label" for="val-username">Status</label>
                                                 <select type="text" class="form-control form-control-lg" id="status" name="status"  required="">
                                                    ...
                                                    <option value="<?php echo $rowinventions1['status'] ?>"><?php echo $rowinventions1['status'] ?></option>
                                          ...
                                          <div class="form-group row">
                                            ...
                                            <input type="hidden" name="tmid" id="tmid" value="<?php echo $_GET['tmid'] ?>">
                                             <input type="hidden" name="tmlogid" id="tmlogid" value="<?php echo $_GET['tmlogid'] ?>">

                                     <div class="form-group row">
                                            <div class="col-12">
                                                <button type="submit" name="updatetrademarklog1" class="btn btn-lg btn-alt-primary pull-right">UPDATE</button>
                                            </div>
                                        </div>
