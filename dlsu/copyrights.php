                ...
                <div class="content">
                    ...
                    <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">Works</h3>
                        </div>

                        <div class="block-content block-content-full">
                      <div class=""><button type="button" class="btn btn-hero btn-info text-uppercase mb-10" onclick="window.location.href = 'create_work.php';">
...
$selectinventions="SELECT * FROM `tblwork`";
 ...
 while ($rowinventions = mysqli_fetch_assoc($runselectinventions))
 {
    ...
    echo ' <tr>
                                        ...
                                        <td class="text-center"><a href="work_milestone.php?workid='.$rowinventions['workid'].'">'.$rowinventions['worktitle'].'</a></td>
...
$x="SELECT * FROM `tblworklogs` WHERE workid='$rowinventions[workid]' ORDER BY worklogid DESC limit 1";
                                  ...
                                  echo '<span class="badge badge-light">'.$rowx['status'].'</span>';
                                    echo '</td>
                                         ...
                                         <td class="text-center">
                                                <div class="btn-group">
                                                   <a href=edit_work.php?workid='.$rowinventions['workid'].'> <button type="button" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Edit">
