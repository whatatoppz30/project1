                            ...
                            <table class="table table-bordered table-striped table-vcenter">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 30%;" class="text-center">log date(date hours-mins)</th>
                                ...
                                <tbody>
                                    ...
                                    $select="SELECT * FROM `tbllogs`";
            $runselect=mysqli_query($conn, $select);
            while($row = mysqli_fetch_assoc($runselect))
            {
                echo '<tr>';
                echo '<td class="text-center">'.$row['username'].'</td>';
                echo '<td class="font-w600 list list-activity text-center">'.$row['datelog'].'</td>';
                echo ' <td class="d-none d-sm-table-cell text-center">';

                if ($row['logaction']=='LOG-IN')
                {
                   echo '  <span class="badge badge-success">'.$row['logaction'].'</span>';
                }
                else
                {
                     echo '  <span class="badge badge-danger">'.$row['logaction'].'</span>';
                }
                ...
                echo  '</tr>';
                                     ...
                                     ?>
                                       ...
                                       <!--  <td class="text-center">1</td>
                                        ...
                                        <td class="font-w600 list list-activity">04/18/2020</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">Nam fringilla magna tempor velit </td>
                                        <td class="font-w600 list list-activity">04/18/2020</td>
                                        <td class="d-none d-sm-table-cell">Admin</td>
                                        <td class="d-none d-sm-table-cell">
                                            <span class="badge badge-danger"><a href="#">Denied</a></span>
                                        </td>
                                    </tr>
