...
$slect="SELECT * FROM `tblotheriplog` WHERE otheripid='$_GET[otheripid]' AND otheriplogid='$_GET[milestoneid]'";
...
{
 $slect1="SELECT * FROM `tblotheripattachment` WHERE logid='CREATED'";
...
{
     $slect1="SELECT * FROM `tblotheripattachment` WHERE logid='$_GET[milestoneid]'";
 $runslect1=mysqli_query($conn, $slect1);
  while ($row1 = mysqli_fetch_assoc($runslect1))
 {
   echo ' <div class="col-md-6 col-xl-3" data-category="claims">
