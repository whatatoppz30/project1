    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o sidebar-inverse enable-page-overlay side-scroll page-header-fixed main-content-narrow">
           ...
           <form action="include/all_query.php" method="post" enctype="multipart/form-data">                  
                             <h2 class="content-heading float-right">Form DIPO-02</h2>
                                ...
                                <div class="block-content">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label class="col-12 p-10 bg-primary-lighter text-primary-dark" for="">1. NON-CONFIDENTIAL TITLE OF INTELLECTUAL PROPERTY (Invention, Utility Model, Industrial Design, etc.) </label>
                                                ...
                                                <textarea class="form-control form-control-lg" id="inventiontitle" name="inventiontitle" rows="6" placeholder="(Invention, Utility Model, Industrial Design, etc.) " required=""></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-12">
                                                <label class="col-12 p-10 bg-primary-lighter text-primary-dark" for="">Transaction Categories </label>
                                            </div>
                                          ...
                                          <div class="form-group row">
                                            <div class="col-12">
                                               <input class="ol-xs-12 col-md-12 form-control form-control-lg" name="category" id="category" value="Record of Invention" readonly="">
                                                 <!--    <option value=""></option>
                                                    <option value="Record of Invention">Record of Invention</option> 
                                                    <option value="Patent Clinic">Patent Clinic</option> 
                                                    ...
                                                    <option value="Patent Maintenance">Patent Maintenance</option> 
...
<input type="hidden" name="contributorcount" id="contributorcount">

                                         <div class="form-group row">
                                        <div class="col-12">

                                            <span class="btn btn-lg btn-alt-primary pull-right fa fa-plus-circle" style="margin-top: 5px;" onclick="addcontributor()"> Add Contributor</span>
                                        </div>
                                         </div>
...
of personnel in the conception and development of the invention.    </label>
                                                ...
                                                <textarea class="form-control form-control-lg" id="sponsor" name="sponsor" rows="6" placeholder="(If none, please indicate “None”)"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-4">
                                                <input type="date" class="form-control form-control-lg" placeholder="Date" id="keyeventdate" name="keyeventdate">
                                            </div>
                                            <div class="col-4">
                                                <input type="text" class="form-control form-control-lg" placeholder="Remarks" id="keyeventremark" name="keyeventremark">
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-4">
                                                <input type="date" class="form-control form-control-lg" placeholder="Date" id="keyeventdate1" name="keyeventdate1">
                                            </div>
                                            <div class="col-4">
                                                <input type="text" class="form-control form-control-lg" placeholder="Remarks" id="keyeventremark1" name="keyeventremark1">
                                            </div>
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-4">
                                                <input type="date" class="form-control form-control-lg" placeholder="Date" id="keyeventdate2" name="keyeventdate2">
                                            </div>
                                            <div class="col-4">
                                                <input type="text" class="form-control form-control-lg" placeholder="Remarks" id="keyeventremark2" name="keyeventremark2">
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-4">
                                                <input type="date" class="form-control form-control-lg" placeholder="Date" id="keyeventdate3" name="keyeventdate3">
                                            </div>
                                            <div class="col-4">
                                                <input type="text" class="form-control form-control-lg" placeholder="Remarks" id="keyeventremark3" name="keyeventremark3">
                                            </div>
...
oral disclosure date and any submissions made for potential publication. </label>
                                            ...
                                            <div class="col-4">
                                                <input type="date" class="form-control form-control-lg" placeholder="Date" id="keyeventdate4" name="keyeventdate4">
                                            </div>
                                            <div class="col-4">
                                                <input type="text" class="form-control form-control-lg" placeholder="Remarks" id="keyeventremark4" name="keyeventremark4">
                                            </div>
...
charts, graphs, drawings, abstracts, presentations, etc.)  </label>
                                            ...
                                            <div class="col-12">
                                                <textarea class="form-control form-control-lg" id="abstract" name="abstract" rows="6" placeholder="ABSTRACT OF THE INVENTION"></textarea>
                                            </div>
...
creative work). </label>
                                            ...
                                            <div class="col-12">
                                                <textarea class="form-control form-control-lg" id="searchitem" name="searchitem" rows="6" placeholder="SEARCH ITEMS"></textarea>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 block">
                                                <textarea class="form-control form-control-lg" id="priora" name="priora" rows="6" placeholder="a.) Prior art includes any publicly available knowledge or related information about the invention available anywhere in the world, including your own 
publications. (attach copies, if available)."></textarea>
</div>

<div class="col-12">
<textarea class="form-control form-control-lg" id="priorb" name="priorb" rows="6" placeholder="b.) Have the essential elements of the invention been communicated to anyone outside of your laboratory either orally or in writing? (public disclosure 
through publication, thesis/dissertation, seminar, poster, meeting, web page, newspaper, etc)  "></textarea>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 block">
                                                <textarea class="form-control form-control-lg" id="commercialvala" name="commercialvala" rows="6" placeholder="a.)  Please describe any known commercial interest in this work, or companies which may have commercial interest in this work and/or give your 
...
<div class="col-12 block">
<textarea class="form-control form-control-lg" id="commercialvalb" name="commercialvalb" rows="6" placeholder="b.)  What are the practical and commercial applications of the inventions?  (What problem does it solve?) "></textarea>
</div>

<div class="col-12 block">
<textarea class="form-control form-control-lg" id="commercialvalc" name="commercialvalc" rows="6" placeholder="c.)  What steps (and how much funding) are necessary for commercialization?   "></textarea>
</div>

<div class="col-12">
<textarea class="form-control form-control-lg" id="commercialvald" name="commercialvald" rows="6" placeholder="d.) What are the advantages of your invention over currently available technologies?  Are there entities and/or dominating patents in this area, if so  
who and/or what are they?  "></textarea>
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-12 block">
                                                <textarea class="form-control form-control-lg" id="descriptiona" name="descriptiona" rows="6" placeholder="a.)  What is the general purpose of the invention?   What is the problem to be solved by the invention? "></textarea>
                                            </div>
                                            <div class="col-12 block">
                                                <textarea class="form-control form-control-lg" id="descriptionb" name="descriptionb" rows="6" placeholder="b.)  Describe the benefits that the invention can give.  "></textarea>
                                            </div>
                                            <div class="col-12 block">
                                                <textarea class="form-control form-control-lg" id="descriptionc" name="descriptionc" rows="6" placeholder="c.) What is new about the invention?  Is there an inventive step?  Is it industrially applicable? "></textarea>
                                            </div>
                                            <div class="col-12 block">
                                                <textarea class="form-control form-control-lg" id="descriptiond" name="descriptiond" rows="6" placeholder="d.) Please attach a more detailed explanation of your invention, including any figures or sketches useful to illustrate it. "></textarea>
                                            </div>
                                            <div class="col-12 block">
                                                <textarea class="form-control form-control-lg" id="descriptione" name="descriptione" rows="6" placeholder="e.) Please describe the stage of development of the invention. "></textarea>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 block">
                                                <textarea class="form-control form-control-lg" id="outsideacta" name="outsideacta" rows="6" placeholder="a) Identify any agreements or interactions that you have entered into that are related to the intellectual property (material transfer agreements, commercially sponsored research agreements, consortia agreements, consulting agreements, technology transfer agreements etc.) "></textarea>
                                            </div>
                                            <div class="col-12 block">
                                                <textarea class="form-control form-control-lg" id="outsideactb" name="outsideactb" rows="6" placeholder="b) Do any of the  listed contributors have consulting or other relevant relationships with entities other than De La Salle University or any  of its affiliates? Please explain and attach any consulting agreements or other contracts."></textarea>
                                            </div>
...
conform to the Intellectual Property Policies of De La Salle University and any future revisions thereto. </p>
                                            ...
                                            <div class="col-xl-4 col-sm-8">
                                                ...
                                                <input type="text" class="form-control form-control-lg" placeholder="Contributor Name" id="contri" name="contri">
                                            </div>
                                            <div class="col-xl-2 col-sm-4">
                                                 <label class="col-form-label" for="val-username">Date</label>
                                                <input type="date" class="form-control form-control-lg" placeholder="date signed" id="contridate" name="contridate">
                                            </div>
                                            <div class="col-xl-4 col-sm-8">
                                                 <label class="col-form-label" for="val-username">Witness’ Signature </label>
                                                <input type="text" class="form-control form-control-lg" placeholder="witness" id="witness" name="witness">
                                            </div>
                                            <div class="col-xl-2 col-sm-4">
                                                 <label class="col-form-label" for="val-username">Date </label>
                                                <input type="date" class="form-control form-control-lg" placeholder="date signed" id="witnessdate" name="witnessdate">
                                            </div>

                                             <div class="col-xl-4 col-sm-8">
                                                 <label class="col-form-label" for="val-username">Signature over Printed Name of Contributor</label>
                                                <input type="text" class="form-control form-control-lg" placeholder="Contributor Name" id="contri1" name="contri1"
>
                                            </div>
                                            <div class="col-xl-2 col-sm-4">
                                                 <label class="col-form-label" for="val-username">Date</label>
                                                <input type="date" class="form-control form-control-lg" placeholder="date signed" id="contridate1" name="contridate1">
                                            </div>
                                            <div class="col-xl-4 col-sm-8">
                                                 <label class="col-form-label" for="val-username">Witness’ Signature </label>
                                                <input type="text" class="form-control form-control-lg" placeholder="witness" id="witness1" name="witness1">
                                            </div>
                                            <div class="col-xl-2 col-sm-4">
                                                 <label class="col-form-label" for="val-username">Date </label>
                                                <input type="date" class="form-control form-control-lg" placeholder="date signed" id="witnessdate1" name="witnessdate1">
                                            </div>

                                             <div class="col-xl-4 col-sm-8">
                                                 <label class="col-form-label" for="val-username">Signature over Printed Name of Contributor</label>
                                                <input type="text" class="form-control form-control-lg" placeholder="Contributor Name" id="contri2" name="contri2">
                                            </div>
                                            <div class="col-xl-2 col-sm-4">
                                                 <label class="col-form-label" for="val-username">Date</label>
                                                <input type="date" class="form-control form-control-lg" placeholder="date signed" id="contridate2" name="contridate2">
                                            </div>
                                            <div class="col-xl-4 col-sm-8">
                                                 <label class="col-form-label" for="val-username">Witness’ Signature </label>
                                                <input type="text" class="form-control form-control-lg" placeholder="witness" id="witness2" name="witness2">
                                            </div>
                                            <div class="col-xl-2 col-sm-4">
                                                 <label class="col-form-label" for="val-username">Date </label>
                                                <input type="date" class="form-control form-control-lg" placeholder="date signed" id="witnessdate2" name="witnessdate2">
                                            </div>
...
<!-- 
                                        ...
                                        <div class="form-group row">
                                            <div class="col-12">
                                                <button type="submit" name="saveinvention" class="btn btn-hero btn-lg btn-success text-uppercase mb-10">SAVE</button>
                                            </div> 
                                        </div>
                                    </form>
                                </div>
