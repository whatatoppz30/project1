                ...
                <div class="content">
                    ...
                    <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">Inventions</h3>
                        </div>

                        <div class="block-content block-content-full">
                            <!-- DataTables functionality is initialized with .js-dataTable-full class in js/pages/be_tables_datatables.min.js which was auto compiled from _es6/pages/be_tables_datatables.js -->
                            <div class=""><button type="button" class="btn btn-hero btn-info text-uppercase mb-10" onclick="window.location.href = 'dipo-form02.php';">
...
$selectinventions="SELECT * FROM `tblinventions`";
 ...
 while ($rowinventions = mysqli_fetch_assoc($runselectinventions))
 {
    ...
    echo ' <tr>
                                        ...
                                        <td class="text-center"><a href="details.php?inventionid='.$rowinventions['inventionid'].'">'.$rowinventions['inventiontitle'].'</a></td>
                                        <td class="font-w600">'.$rowinventions['inventiondatefilled'].'</td>
                                        <td class="d-none d-sm-table-cell">'.$rowinventions['contributorname'].',';

$selectinventions1="SELECT * FROM  tbliventioncontributor WHERE iprecordid ='$rowinventions[inventionid]'";
 $runselectinventions1=mysqli_query($conn, $selectinventions1);

 while ($rowinventions1 = mysqli_fetch_assoc($runselectinventions1))
 {

    echo $rowinventions1['contributorname'].' , ';
 }
...
echo '
                                            <span class="badge badge-light">'.$rowx['status'].'</span>
                                        </td>
