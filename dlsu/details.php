            ...
            <main id="main-container">
                ...
                <div class="content">
                    ...
                    <div class="block-content" id="formBlock">
                        ...
                        <div class=""> <a href="invention_addmilestone.php?inventionid=<?php echo $_GET['inventionid'] ?>"><button type="button" class="btn btn-hero btn-info text-uppercase mb-10">
                                    <i class="fa fa-plus mr-5"></i>Add Milestone</button></a></div>  
<h3  >
                                    <?php 


$selectinventions1="SELECT * FROM `tblinventions` WHERE inventionid ='$_GET[inventionid]'  ";
 $runselectinventions1=mysqli_query($conn, $selectinventions1);

$rowinventions1 = mysqli_fetch_assoc($runselectinventions1);

echo $rowinventions1['inventiontitle'];
                             ?>
</h3>
...
$selectinventions="SELECT * FROM `tblinventionlog` WHERE inventionid ='$_GET[inventionid]' ORDER BY inventionlogid DESC";
...
else
{
     echo '<td>'.$rowinventions['notification'].'</td>';
                                       ...
                                       <td> 
                                        ...
                                        <a href="edit_invention1.php?inventionid='.$_GET['inventionid'].'&tmlogid='.$rowinventions['inventionlogid'].'">
                                       <span type="btn" class="btn btn-sm btn-secondary fa fa-pencil" title="info"></span>
                                        ...
                                        echo '<td>
                                        <a href="invention_view_attachment.php?inventionid='.$_GET['inventionid'].'&inventionlogid='.$rowinventions['inventionlogid'].'"> <button onclick="location.href=details.php" type="button" class="btn btn-sm btn-secondary" title="info">View Attachment</button></a></td>  </tr>';
