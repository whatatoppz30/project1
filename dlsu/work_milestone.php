        ...
        <div id="page-container" class="sidebar-o sidebar-inverse enable-page-overlay side-scroll page-header-fixed main-content-narrow">
            ...
            <main id="main-container">
                ...
                <div class="content">
                 ...
                 <div class=""> <a href="work_addmilestone.php?tmid=<?php echo $_GET['workid'] ?>"><button type="button" class="btn btn-hero btn-info text-uppercase mb-10">
...
$selectinventions1="SELECT * FROM `tblwork` WHERE workid ='$_GET[workid]'  ";
...
$selectinventions="SELECT * FROM `tblworklogs` WHERE workid ='$_GET[workid]' ORDER BY worklogid DESC";
     ...
     echo '<td>'.$rowinventions['notification'].'</td>';
                                 ...
                                 echo ' <td><span class=""><a href="#">'.$rowinventions['status'].'</a></span></td>
                                        <td class="text-center">
                                                <div class="btn-group">
                                                   <a href=edit_invention.php?workid='.$rowinventions['workid'].'&worklogid='.$rowinventions['worklogid'].'> <button type="button" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="Edit">
                                                        <i class="fa fa-pencil"></i>
                                                    </button>
                                                    </td>
                                        <td>
                                        <a href="copyright_view_attachment.php?copyrightid='.$_GET['workid'].'&milestoneid='.$rowinventions['worklogid'].'">
