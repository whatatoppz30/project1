        ...
        <div id="page-container" class="sidebar-o sidebar-inverse enable-page-overlay side-scroll page-header-fixed main-content-narrow">
            ...
            <main id="main-container">
                ...
                <div class="content">
                    ...
                    <!-- Dynamic Table Full -->
                    <div class="block">
                         <div class=""> <a href="partner_history.php?partnerid=<?php echo $_GET['partnerid'] ?>"><button type="button" class="btn btn-hero btn-info text-uppercase mb-10">
...
$selectinventions1="SELECT * FROM `tblpartner` WHERE partnerid ='$_GET[partnerid]'  ";
 $runselectinventions1=mysqli_query($conn, $selectinventions1);

$rowinventions1 = mysqli_fetch_assoc($runselectinventions1);

echo strtoupper($rowinventions1['partnername']);
                             ?>
</h3>  
...
$selectinventions="SELECT * FROM `tblpartnerlog` WHERE partnerid ='$_GET[partnerid]'";
...
else
{
     echo '<td>'.$rowinventions['notification'].'</td>';
                                       ...
                                       echo' <td><span class="badge ">'.strtoupper($rowinventions['status']).'</span></td>

                                       <td> 

                                        <a href="edit_innovation.php?partnerid='.$_GET['partnerid'].'&partnerlogid='.$rowinventions['partnerlogid'].'">
                                       <span type="btn" class="btn btn-sm btn-secondary fa fa-pencil" title="info"></span>
                                        </a>
                                       </td>

                                         <td> 
                                       <a href="partner_view_attachment.php?partnerid='.$_GET['partnerid'].'&logid='.$rowinventions['partnerlogid'].'">
