                     ...
                     <div class="block">
                         ...
                         <div class="block-content">
                            ...
                            <form action="include/all_query.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                          ...
                                          <div class="form-group row">
                                               ...
                                               <label class="col-12 p-10 bg-primary-lighter text-primary-dark" for="">Attach File</label>
                                                  ...
                                                  <div class="col-7" id="atachmentdiv1">
                                            ...
                                            <div class="form-group row">
                                            <div class="col-12">
                                            <span class="btn btn-lg btn-alt-primary pull-right fa fa-plus-circle" style="margin-top: 5px;" onclick="addfile1()"> Add More File</span>
                                            </div>
                                           </div>
                                     ...
                                     <div class="form-group row">
                                            <div class="col-12">
                                                <button type="submit" name="updatetrademarklog" class="btn btn-lg btn-alt-primary pull-right fa fa-plus-circle"> ADD</button>
                                            </div>
                                        </div>
