        ...
        <div id="page-container" class="sidebar-o sidebar-inverse enable-page-overlay side-scroll page-header-fixed main-content-narrow">
            ...
            <main id="main-container">
                ...
                <div class="content">
                 ...
                 <div class=""> <a href="trademark_addmilestone.php?tmid=<?php echo $_GET['tmid'] ?>"><button type="button" class="btn btn-hero btn-info text-uppercase mb-10">
...
$selectinventions1="SELECT * FROM `tbltrademark` WHERE trademarkid ='$_GET[tmid]'  ";
 $runselectinventions1=mysqli_query($conn, $selectinventions1);

$rowinventions1 = mysqli_fetch_assoc($runselectinventions1);

echo strtoupper($rowinventions1['marktitle']);
                             ?>
</h3>
...
$selectinventions="SELECT * FROM `tbltrademarklog` WHERE trademarkid ='$_GET[tmid]' ORDER BY trademarklog DESC";
...
else
{
     echo '<td>'.$rowinventions['notification'].'</td>';
                                       ...
                                       <td> 
                                        ...
                                        <a href="edit_trademark.php?tmid='.$_GET['tmid'].'&tmlogid='.$rowinventions['trademarklog'].'">
                                       <span type="btn" class="btn btn-sm btn-secondary fa fa-pencil" title="info"></span>
                                        ...
                                        <td> 
                                        <a href="trademark_milestone_attachment.php?tmid='.$_GET['tmid'].'&tmlogid='.$rowinventions['trademarklog'].'">
